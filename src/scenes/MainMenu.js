...
export class MainMenu extends Scene
{
    ...
    create ()
    {
        ...
        // Game title
        this.add.text(512, 180, 'Tides of Time', {
        ...
        // Subtitle
        this.add.text(512, 250, 'A Meditative Wave Balancer', {
            fontFamily: 'Arial', 
            fontSize: 28, 
            color: '#ffffff',
            stroke: '#000000', 
        ...
        this.add.text(512, 340, description, {
            fontFamily: 'Arial', 
            fontSize: 20, 
            color: '#ffffff',
            stroke: '#000000', 
        ...
        // Instructions
        this.add.text(512, 450, 'Drag left/right to control the waves', {
            fontFamily: 'Arial', 
            fontSize: 24, 
            color: '#ffffff',
            stroke: '#000000', 
        ...
        const playText = this.add.text(512, 550, 'Play Game', {
            fontFamily: 'Arial', 
            fontSize: 28, 
            color: '#ffffff'
        }).setOrigin(0.5);
